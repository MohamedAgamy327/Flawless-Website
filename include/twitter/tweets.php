...
if( isset( $_GET['username'] ) AND $_GET['username'] != '' ):
    ...
    $consumerkey = "9nrWjm0HVVxeNnkdGRGqT7yeA";  //Enter API key
    $consumersecret = "UD3PkyhGs2uUrhQCduD6c1sDR935EYHhXbnLsyGRh8AmxzTX1b";  //Enter API secret
    $accesstoken = "221530081-ln3tktflm5FYHQK80plxThQxbnlQW8CxxmFuN36C";  //Enter Access token
    $accesstokensecret = "eyXMjYRJerdOOWdIK0oNluoBnsG0AC5QVDuwC3e380V0t";  //Enter Access token secret
